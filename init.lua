...
map('n', '<leader>rt', '<cmd>Rosalyn target<CR>', 'Choose Project target')
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        ...
        typescript = { 'prettierd', 'prettier', stop_after_fist = true },
        json = { 'prettierd', 'prettier', stop_after_fist = true },
        html = { 'prettierd', 'prettier', stop_after_fist = true },
